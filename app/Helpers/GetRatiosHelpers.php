...
class GetRatiosHelpers
{
    ...
    */
    ...
    public static function rif($entreprise, $exercice, $bd)
    {
        ...
        $op2 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
    ...
    public static function rifUEMOA($exercice)
    {
        ...
        $op2 = DB::connection('bic_uemoa')->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [22, 24, 27, 28, 31, 32])
            ->where('exercice', $exercice)
            ->first();
    ...
    {
        $op1 = DB::table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [39, 41, 42])
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();
        $op2 = DB::table('lignebilans')
            ->selectRaw('SUM(brute) as total')
        ...
        if (!$op1): $op1 = 0;
        else: $op1 = (int)$op1->total; endif;
        if (!$op2): $op2 = 0;
        else: $op2 = (int)$op2->total; endif;
    ...
    {
        $op1 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [39, 41, 42])
            ->where('exercice', $exercice)
            ->first();
        $op2 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [39, 41])
            ->where('exercice', $exercice + 1)
    ...
    {
        $pb = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
    ...
    {
        $cb = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
    ...
    {
        $api = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
    ...
    /* 8. Resultat brute D'exploitation apres amortissement */
    ...
    {
        $op1 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
    ...
    */
    ...
    {
        $numer = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->where('idRubrique', 44)
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
    ...
    {
        $numer = DB::connection('bic_uemoa')->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->where('idRubrique', 44)
            ->where('exercice', $exercice)
            ->first();
        /* Compte rénuméré */
        $op1 = DB::connection('bic_uemoa')->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [24, 25, 27])
            ->where('exercice', $exercice)
            ->first();
    ...
    */
    ...
    {
        return DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
    ...
    */
    ...
    public static function totalBilan($entreprise, $exercice, $bd)
    {
        return DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total ')
            ->join('rubrique', 'rubrique.idRubrique', '=', 'lignebilans.idRubrique')
    ...
    {
        return DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->selectRaw('SUM(brute) as total ')
            ->join('rubrique', 'rubrique.idRubrique', '=', 'lignebilans.idRubrique')
            ->join('sousclasse', 'sousclasse.idSousclasse', '=', 'rubrique.idSousclasse')
    ...
    public static function pnbNew($entreprise, $exercice, $bd)
    {
        $pb1 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [99, 101, 102, 104, 105, 106])
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();
        $pb2 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [100, 103, 107])
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();

        if (!$pb1): $pb1 = 0;
        else: $pb1 = (int)$pb1->total; endif;
        if (!$pb2): $pb2 = 0;
        else: $pb2 = (int)$pb2->total; endif;
        return $pb1 - $pb2;
    }

    public static function pnbNewPays($exercice, $bd)
    {
        $pb1 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [99, 101, 102, 104, 105, 106])
    ...
    public static function pnbNewUEMOA($exercice)
    {
        $pb1 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [99, 101, 102, 104, 105, 106])
            ->where('exercice', $exercice)
            ->first();
        $pb2 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [100, 103, 107])
            ->where('exercice', $exercice)
    ...
    public static function rbeNew($entreprise, $exercice, $bd)
    {
        $op1 = GetRatiosHelpers::pnbNew($entreprise, $exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [108, 109, 110])
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();
        if (!$op2): $op2 = 0;
    ...
    public static function rbeNewPays($exercice, $bd)
    {
        $op1 = GetRatiosHelpers::pnbNewPays($exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [108, 109, 110])
            ->where('exercice', $exercice)
    ...
    public static function rbeNewUEMOA($exercice)
    {
        $op1 = GetRatiosHelpers::pnbNewUEMOA($exercice);
        $op2 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->selectRaw('SUM(brute) as total')
            ->whereIn('idRubrique', [108, 109, 110])
    ...
    public static function reNew($entreprise, $exercice, $bd)
    {
        $op1 = GetRatiosHelpers::rbeNew($entreprise, $exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->where('idRubrique', 111)
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();
        if (!$op2): $op2 = 0;
        else: $op2 = (int)$op2->brute; endif;
        return (int)($op1 - $op2);
    }

    public static function reNewPays($exercice, $bd)
    {
        $op1 = GetRatiosHelpers::rbeNewPays($exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->where('idRubrique', 111)
            ->where('exercice', $exercice)
            ->first();
    ...
    public static function reNewUEMOA($exercice)
    {
        $op1 = GetRatiosHelpers::rbeNewUEMOA($exercice);
        $op2 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->where('idRubrique', 111)
            ->where('exercice', $exercice)
    ...
    public static function raiNew($entreprise, $exercice, $bd)
    {
        $op1 = GetRatiosHelpers::reNew($entreprise, $exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->where('idRubrique', 112)
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();
        if (!$op2): $op2 = 0;
    ...
    public static function raiNewPays($exercice, $bd)
    {
        $op1 = GetRatiosHelpers::reNewPays($exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->where('idRubrique', 112)
            ->where('exercice', $exercice)
            ->first();
    ...
    public static function raiNewUEMOA($exercice)
    {
        $op1 = GetRatiosHelpers::reNewUEMOA($exercice);
        $op2 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->where('idRubrique', 112)
            ->where('exercice', $exercice)
    ...
    public static function rnNew($entreprise, $exercice, $bd)
    {
        $op1 = GetRatiosHelpers::raiNew($entreprise, $exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->where('idRubrique', 113)
            ->where('idEntreprise', $entreprise)
            ->where('exercice', $exercice)
            ->first();
        if (!$op2): $op2 = 0;
    ...
    public static function rnNewPays($exercice, $bd)
    {
        $op1 = GetRatiosHelpers::raiNewPays($exercice, $bd);
        $op2 = DB::connection($bd)->table('lignebilans')
            ->where('idRubrique', 113)
            ->where('exercice', $exercice)
            ->first();
    ...
    public static function rnNewUEMOA($exercice)
    {
        $op1 = GetRatiosHelpers::raiNewUEMOA($exercice);
        $op2 = DB::connection('bic_uemoa')
            ->table('lignebilans')
            ->where('idRubrique', 113)
            ->where('exercice', $exercice)
