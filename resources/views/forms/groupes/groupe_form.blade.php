...
@section("forms")
<div class="card-body">
    <form action="{{ route('groupe.bilan.store') }}" method="post" target="index">
        <div class="card-body">
            @csrf
            <div class="form-group row">
                <div class="col col-md-4 col-sm-3">
                    ...
                    <div class="row">
                        <input style="font-family: 'Times New Roman';font-size: 17px;height: 50%; width: 80%;"
                            ...
                            placeholder="Commencer à écrire le nom du groupe ..." name="groupe" autocomplete="off">
                        <script type="text/javascript">
                            var path = "{{ route('autocompleteGroupe') }}";
                ...
                <div class="col col-md-2 col-sm-3">
                    ...
                    <div class="row py-1"
                        style="font-family: 'Times New Roman, Times, serif';font-size: 17px; align-items: center;">
                        <label for=""><input type="radio" name="naturep" value="paran" checked> Par
                            année</label>&nbsp;&nbsp;
                    ...
                    <div class="row " style="font-family: 'Times New Roman, Times, serif';font-size: 17px;">
                        <div class="form-inline">
                            <div class="form-group mx-sm-3 mb-2">
                                <label for="inputPassword2">Exercice 1</label>
...
@stop
@section('content')
<iframe src="" name="index" style="width: 100%; height: 520px; border-width: 0"></iframe>
@stop